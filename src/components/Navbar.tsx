...
import SubRed from "../assets/SubRed.png";
          ...
          <div className="flex items-center justify-between">
            <div className="flex ms-2 items-center justify-start rtl:justify-end">
              ...
              >
                ...
                <h1 className="mx-1 font-bold text-xl">SubRed</h1>
              </a>
            </div>
            <div className="relative flex gap-2 items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              <button
                ...
                className="block mx-2 p-2 bg-transparent hover:bg-gray-300 focus:ring-4 focus:ring-primary-300 font-medium rounded-2xl text-sm dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              >
                <svg
                  width="16"
                  height="16"
